...
namespace MO_32_2_Chuprova_BoxBox.NeuroNet
{
    ...
    {
        public OutputLayer(int non, int nopn, NeuronType nt, string nm_layer, ActivationType actType = ActivationType.Linear, double dropoutProb = 0.0) : base(non, nopn, nt, nm_layer, actType, dropoutProb) { }
        ...
        public override double[] BackwardPass(double[] errors)
        {
            ...
            for (int j = 0; j < numofprevneurons; j++)
            {
                ...
                // Поменяли местами +1, чтобы пропустить порог
